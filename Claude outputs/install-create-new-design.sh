mkdir -p ~/.claude/skills/create-new-design
cat <<'CREATE_NEW_DESIGN_SKILL_EOF' > ~/.claude/skills/create-new-design/SKILL.md
---
...
instead of it.
CREATE_NEW_DESIGN_SKILL_EOF
echo "Wrote $(wc -l < ~/.claude/skills/create-new-design/SKILL.md) lines to ~/.claude/skills/create-new-design/SKILL.md"
